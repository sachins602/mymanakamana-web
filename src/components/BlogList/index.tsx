  ...
  return (
    <div className=''>
      <h1 className='text-3xl pb-8'>
        Interesting <span className='text-green-500 font-bold'>Blogs</span>
      </h1>
        ...
        <div className='bg-white shadow-lg shadow-green-200 absolute z-50 top-[50%] w-[90%] py-4 px-2'>
          <div className='pb-4'>
            <h2 className='text-sm font-semibold'>
              Travel Tips During Langtang Tour
            </h2>
            ...
            <p className='text-xs'>
              Dorem ipsum dolor sit amet, conse adipiscing elit. Etiam eu turpis
